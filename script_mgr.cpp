...
//	RegisterString(mpEngine);
	...
	if (!strstr(asGetLibraryOptions(), "AS_MAX_PORTABILITY")) {
		...
		result = mpEngine->RegisterGlobalFunction("void printf(const string &in, ?&in, ?&in)", asFUNCTION(asPrintf2), asCALL_CDECL); assert(result >= 0);
		result = mpEngine->RegisterGlobalFunction("void printf(const string &in, ?&in, ?&in, ?&in)", asFUNCTION(asPrintf3), asCALL_CDECL); assert(result >= 0);
		result = mpEngine->RegisterGlobalFunction("void printf(const string &in, ?&in, ?&in, ?&in, ?&in)", asFUNCTION(asPrintf4), asCALL_CDECL); assert(result >= 0);
		...
		result = mpEngine->RegisterGlobalFunction("void printf(const string &in, ?&in, ?&in)", asFUNCTION(asPrintf2Generic), asCALL_GENERIC); assert(result >= 0);
		result = mpEngine->RegisterGlobalFunction("void printf(const string &in, ?&in, ?&in, ?&in)", asFUNCTION(asPrintf3Generic), asCALL_GENERIC); assert(result >= 0);
		result = mpEngine->RegisterGlobalFunction("void printf(const string &in, ?&in, ?&in, ?&in, ?&in)", asFUNCTION(asPrintf4Generic), asCALL_GENERIC); assert(result >= 0);
